      ...
      <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
          <div class="modal-header flex-sm-row flex-column">
            ...
            <div class="col-lg-8">
              <h2 class="modal-title fs-5" id="staticBackdropLabel">ليزا هانسون</h2>
        ...
        <div class="modal-content">
          <div class="modal-header flex-sm-row flex-column">
            ...
            <div class="col-lg-8">
              ...
              <p class="text-white m-0">مذيعة رياضية ومقدمة برامج تلفزيونية</p>
            </div>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col-6 col-sm-4 col-md-4 col-lg-2">
            <div class="cs_team cs_style_1 text-center cs_mb_25 overflow-hidden cs_rounded_50">
              ...
              <div class="cs_team_info cs_pt_127 cs_pl_15 cs_pr_15 cs_pb_25 cs_transition_4 cs_rounded_50">
                <h2 class="text-white cs_fs_20 cs_mb_10">ليزا هانسون</h2>
          ...
          <div class="col-6 col-sm-4 col-md-4 col-lg-2">
            <div class="cs_team cs_style_1 text-center cs_mb_25 overflow-hidden cs_rounded_50">
              ...
              <div class="cs_team_info cs_pt_127 cs_pl_15 cs_pr_15 cs_pb_25 cs_transition_4 cs_rounded_50">
                ...
                <p class="text-white cs_fs_12 m-0 lh-base">مذيعة رياضية ومقدمة برامج تلفزيونية</p>
              </div>
            </div>
          </div>
          <div class="col-6 col-sm-4 col-md-4 col-lg-2">

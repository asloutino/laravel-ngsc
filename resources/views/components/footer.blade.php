  ...
  <div class="container">
    <div class="cs_footer_top d-flex justify-content-between align-items-start align-items-md-center cs_pt_46 cs_pb_46 cs_column_gap_15 cs_row_gap_15 flex-md-row  flex-column">
      <div class="cs_footer_contact_info">
        ...
        <h2 class="text-white fw-medium m-0 cs_fs_22">+966 5 12345678 </h2>
      </div>
      ...
      <div class="cs_footer_contact_info">
        ...
        <h2 class="text-white fw-medium m-0 cs_fs_22"><a target="_blank" href="mailto:conference@worldcupfoundation.org">conference@worldcupfoundation.org</a></h2>
      </div>
    </div>
        ...
        <div class="col-lg-3">
          <div class="cs_footer_item cs_pt_20 cs_pb_20">
            <div class="cs_newsletter cs_style_1">
              ...
              <p class="cs_newsletter_subtitle cs_mb_26">Be the first to know about our latest updates, exclusive offers, and special events. Join our community today!</p>
